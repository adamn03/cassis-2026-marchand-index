...
*Originally: conference poster + live demo, Sports Analytics Conference 2026.*

> **DELIVERABLE CHANGED 2026-08-27 — CASSIS is off** (owner made the Mann Cup and cannot
> attend). The output is now a **public GitHub writeup** of the ranking + findings, aimed at
> a general technical reader rather than a room of statisticians. **The method is unchanged**
> — everything below and in `marchand_index/preregistration.md` still governs. What changed
> is who it is written for: clarity now outranks sophistication. Deliverable spec and task
> order live in the root `SESSION.md`.
